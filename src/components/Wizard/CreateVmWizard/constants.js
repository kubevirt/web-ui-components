...
export const PROVIDER_VMWARE_NAMESPACE_ALERT_KEY = 'vmwareNamespaceAlert';
export const PROVIDER_VMWARE_HOSTNAME_KEY = 'vmwareHostname';
export const PROVIDER_VMWARE_USER_PWD_REMEMBER_KEY = 'rememberVmwareCredentials';
export const PROVIDER_VMWARE_VM_DATA_KEY = 'vmwareVmData';
...
// probably no need to make the name generic
