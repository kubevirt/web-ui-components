...
describe('getVmStatus()', () => {
  vmFixtures.forEach((fixture, idx) => {
    ...
    it(`return status correctly ${idx} (${resultStatus})`, () => {
      expect(getVmStatus(fixture.vm, fixture.podsFixture, fixture.migrations).status).toBe(resultStatus);
    });
  });
});
...
describe('getSimpleVmStatus()', () => {
  vmFixtures.forEach((fixture, idx) => {
    it(`return simple status correctly ${idx} (${fixture.expectedSimple})`, () => {
      expect(getSimpleVmStatus(fixture.vm, fixture.podsFixture, fixture.migrations)).toBe(fixture.expectedSimple);
    });
  });
});
